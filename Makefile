...
CC_OPTS = -ffreestanding -O3 -Wall -Wextra
...
kernel_main.o: kernel_main.cc
	$(GCC) -c kernel_main.cc -o kernel_main.o $(CC_OPTS) -fno-exceptions
...
kernel.bin: boot.o kernel_main.o vga_terminal.o linker.ld
	$(GCC) -T linker.ld -o kernel.bin -ffreestanding -nostdlib -O3 *.o -lgcc -lstdc++
